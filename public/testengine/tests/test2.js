describe("Task 2 - different search source", function () {
  const desc =
    "<p>Change your <code>ImagesResolver</code> from previous task so that you can add different sources for search.</p>" +
  ...
  describe(desc, function () {
    it("must throw exception if module id is unknown", function () {
      ...
      // Updated because search should be asynchronius
      expect(async function async() {
        try {
