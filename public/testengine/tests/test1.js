describe("Task 1 - Search local data", function () {
  const desc =
    "<p>You must modify <code>ImagesResolver.search()</code> method to search strictly by the field 'tags' in <a href='/js/local.db.js' target='_blank'><strong>window.localDB</strong></a></p>" +
    "<p>For example:</p>" +
